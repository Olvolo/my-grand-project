                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex flex-col">
                    ...
                    <div class="text-gray-600 text-sm mb-3">
                        ...
                        @if ($article->category)
                            ...
                            <a href="{{ route('categories.show', $article->category) }}" class="text-blue-600 hover:underline">
                        ...
                        @if ($article->tags->isNotEmpty())
                            ...
                            @foreach ($article->tags as $tag)
                                <a href="{{ route('tags.show', $tag) }}" class="inline-block bg-gray-200 rounded-full px-2 py-0.5 text-xs font-semibold text-gray-700 hover:bg-gray-300">
                                    #{{ $tag->name }}
                                </a>@if (!$loop->last), @endif
                            @endforeach
                        @endif
