        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('admin.chapters.update', $chapter)); ?>" method="POST" class="p-6 bg-white rounded-lg shadow-md space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $chapter->title)); ?>" class="markdown-editor block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                </div>

                <div>
                    <label for="content_markdown" class="block text-sm font-medium text-gray-700">Содержимое (Markdown)</label>
                    <textarea name="content_markdown" id="content_markdown" rows="20" class="markdown-editor block w-full mt-1 border-gray-300 rounded-md shadow-sm"><?php echo e(old('content_markdown', $chapter->content_markdown)); ?></textarea>
                </div>
