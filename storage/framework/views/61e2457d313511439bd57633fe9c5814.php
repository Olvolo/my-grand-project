<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        <p class="text-center text-gray-600 text-lg">В категории "<?php echo e($category->name); ?>" пока нет статей.</p>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH N:\www\my-grand-project\resources\views/categories/show.blade.php ENDPATH**/ ?>