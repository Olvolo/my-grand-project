<?php $__env->startSection('content'); ?>
    <h1 class="text-4xl font-extrabold text-gray-900 mb-8 text-center">Все Статьи</h1>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex flex-col">
                    ...
                    <div class="text-gray-600 text-sm mb-3">
                        ...
                        <?php if($article->category): ?>
                            ...
                            <a href="<?php echo e(route('categories.show', $article->category)); ?>" class="text-blue-600 hover:underline">
                        ...
                        <?php if($article->tags->isNotEmpty()): ?>
                            <span class="mx-1">|</span> Теги:
                            <?php $__currentLoopData = $article->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('tags.show', $tag)); ?>" class="inline-block bg-gray-200 rounded-full px-2 py-0.5 text-xs font-semibold text-gray-700 hover:bg-gray-300">
                                    #<?php echo e($tag->name); ?>
    ...
    <?php else: ?>
        <p class="text-center text-gray-600 text-lg">Пока нет добавленных статей.</p>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH N:\www\my-grand-project\resources\views/articles/index.blade.php ENDPATH**/ ?>